...
# node init
# ----------
rospy.init_node('ardupi_robot_driver_PID', anonymous=True)
...
rospy.Subscriber("ardupi_robot/omegaRef/left", Float32, callBackLeftOmegaRef)
rospy.Subscriber("ardupi_robot/omegaRef/right", Float32, callBackRightOmegaRef)
